    ...
    <main id="main-content">
      ...
      <div class="result-area">
        ...
        <div class="relation-chart">
          ...
          <div ref="chartContainer" id="chain-chart" class="chart-container"></div>
        </div>
        ...
        <div class="result-panel">
          ...
          <div class="picture-container" v-if="showPicture">
            <img :src="pictureSrc" :alt="currentCharacter" class="character-picture">
          </div>
          ...
          <div class="info-panel">
            <div class="character-name" v-if="currentCharacter">{{ currentCharacter }}</div>
...
const mockAnswers: Record<string, any> = {
  '贾宝玉的爸爸是谁': {
    ...
    profile: '<dl><dt>中文名</dt><dd>贾政</dd><dt>身份</dt><dd>荣国府二老爷</dd><dt>官职</dt><dd>工部员外郎</dd><dt>性格</dt><dd>为人正直，古板严肃</dd></dl>',
    picture: null
  },
  '林黛玉的母亲是谁': {
    nodes: [
    ...
    profile: '<dl><dt>中文名</dt><dd>贾敏</dd><dt>身份</dt><dd>林如海之妻</dd><dt>家世</dt><dd>贾府千金</dd><dt>子女</dt><dd>林黛玉</dd></dl>',
    picture: null
  },
  '薛宝钗的哥哥是谁': {
    nodes: [
    ...
    links: [
      { source: '薛宝钗', target: '薛蟠', value: '兄妹' },
    ],
    profile: '<dl><dt>中文名</dt><dd>薛蟠</dd><dt>身份</dt><dd>薛家长子</dd><dt>性格</dt><dd>纨绔子弟，性情骄纵</dd><dt>绰号</dt><dd>呆霸王</dd></dl>',
    picture: null
  },
  '王熙凤的丈夫是谁': {
    nodes: [
    ...
    profile: '<dl><dt>中文名</dt><dd>贾琏</dd><dt>身份</dt><dd>荣国府管家</dd><dt>性格</dt><dd>风流成性，贪图享乐</dd></dl>',
    picture: null
  },
  '贾母的孙子是谁': {
    nodes: [
    ...
    profile: '<dl><dt>中文名</dt><dd>贾宝玉</dd><dt>身份</dt><dd>荣国府嫡孙</dd><dt>性格</dt><dd>叛逆多情，厌恶仕途</dd><dt>别称</dt><dd>宝二爷</dd></dl>',
    picture: null
  },
  '秦可卿是谁': {
    nodes: [
    ...
    profile: '<dl><dt>中文名</dt><dd>秦可卿</dd><dt>外文名称</dt><dd>Qin Keqing</dd><dt>其他名称</dt><dd>秦氏、蓉大奶奶</dd><dt>身份</dt><dd>宁国府重孙媳妇，贾蓉之妻</dd><dt>排名</dt><dd>金陵十二钗正册第十二位</dd></dl>',
    picture: null
  },
};
  ...
  try {
    ...
    if (json && Array.isArray(json) && json.length >= 3) {
      ...
      displayResult({
        ...
        profile: '<dl><dt>提示</dt><dd>未找到相关答案，请尝试其他问题</dd></dl>',
        picture: null
      });
    }
  } catch (error) {
...
// 显示结果
const displayResult = (data: { nodes: any[], links: any[], profile: string, picture: string | null }) => {
  // 更新图表
  if (chartInstance) {
